%==============================================
% WorldTheory.pl for actor qaproximitysensor
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqaproximitysensor).	%%old version (deprecated)
actorobj(qatuqaproximitysensor).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qaproximitysensor
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qaproximitysensor" ). 
...
%-------------------------------------------------
%  User static rules about qaproximitysensor
%------------------------------------------------- 
/*
------------------------------------------------------------------------
