%==============================================
% WorldTheory.pl for actor qarobot4
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqarobot4).	%%old version (deprecated)
actorobj(qatuqarobot4).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qarobot4
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qarobot4" ). 
...
%-------------------------------------------------
%  User static rules about qarobot4
%------------------------------------------------- 
/*
------------------------------------------------------------------------
