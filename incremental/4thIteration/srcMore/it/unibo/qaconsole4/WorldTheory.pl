%==============================================
% WorldTheory.pl for actor qaconsole4
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqaconsole4).	%%old version (deprecated)
actorobj(qatuqaconsole4).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qaconsole4
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qaconsole4" ). 
...
%-------------------------------------------------
%  User static rules about qaconsole4
%------------------------------------------------- 
/*
------------------------------------------------------------------------
