%==============================================
% WorldTheory.pl for actor qarobot
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqarobot).	%%old version (deprecated)
actorobj(qatuqarobot).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qarobot
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qarobot" ). 
...
%-------------------------------------------------
%  User static rules about qarobot
%------------------------------------------------- 
r1:-assert( rStart).
r2:-assert( rStop).
protototo.
