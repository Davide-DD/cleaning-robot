...
public abstract class AbstractQarobot2 extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractQarobot2(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/qarobot2/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/qarobot2/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	        ...
	        switchToPlanAsNextState(pr, myselfName, "qarobot2_"+myselfName, 
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	//bbb
	     msgTransition( pr,myselfName,"qarobot2_"+myselfName,false,
	          new StateFun[]{stateTab.get("handleConsoleMsg"), stateTab.get("handleEnvironmentalEvent") }, 
	          new String[]{"true","M","consoleMsg", "true","E","environmentalEvent" },
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("handleConsoleMsg",-1);
	    	...
	    	repeatPlanNoTransition(pr,myselfName,"qarobot2_"+myselfName,false,true);
