%==============================================
% WorldTheory.pl for actor qaledproban
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqaledproban).	%%old version (deprecated)
actorobj(qatuqaledproban).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qaledproban
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qaledproban" ). 
...
%-------------------------------------------------
%  User static rules about qaledproban
%------------------------------------------------- 
ledmodel( name( genericled),value( off)).
switchLedValue( on):-ledmodel( name( genericled),value( off)),replaceRule( ledmodel( NAME,value( off)),ledmodel( NAME,value( on))), ! .
switchLedValue( off):-ledmodel( name( genericled),value( on)),replaceRule( ledmodel( NAME,value( on)),ledmodel( NAME,value( off))), ! .
/*
------------------------------------------------------------------------
