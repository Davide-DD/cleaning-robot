%==============================================
% WorldTheory.pl for actor qaconsole3
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqaconsole3).	%%old version (deprecated)
actorobj(qatuqaconsole3).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qaconsole3
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qaconsole3" ). 
...
%-------------------------------------------------
%  User static rules about qaconsole3
%------------------------------------------------- 
/*
------------------------------------------------------------------------
