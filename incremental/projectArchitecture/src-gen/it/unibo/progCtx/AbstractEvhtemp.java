...
public abstract class AbstractEvhtemp extends EventHandlerComponent { 
protected IEventItem event;
	public AbstractEvhtemp(String name, QActorContext myCtx, IOutputEnvView outEnvView, String[] eventIds ) throws Exception {
	...
	public void handleCurrentEvent() throws Exception {
		...
		Term msgPattern = Term.createTerm("tempEvent(VALUE)");
				boolean b = this.pengine.unify(msgt, msgPattern);
				if( b ) {
			  		sendMsg("tempMsg","qabusinesslogicproban", QActorContext.dispatch, msgt.toString() ); 
				}else{
