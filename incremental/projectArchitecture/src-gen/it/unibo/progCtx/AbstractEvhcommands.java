...
public abstract class AbstractEvhcommands extends EventHandlerComponent { 
protected IEventItem event;
	public AbstractEvhcommands(String name, QActorContext myCtx, IOutputEnvView outEnvView, String[] eventIds ) throws Exception {
	...
	public void handleCurrentEvent() throws Exception {
		...
		Term msgPattern = Term.createTerm("manageCommands(SENDER,DATA)");
				boolean b = this.pengine.unify(msgt, msgPattern);
				if( b ) {
			  		sendMsg("manageCommandsMsg","qafrontend", QActorContext.dispatch, msgt.toString() ); 
				}else{
