%==============================================
% WorldTheory.pl for actor qasoffrittirobot
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqasoffrittirobot).	%%old version (deprecated)
actorobj(qatuqasoffrittirobot).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qasoffrittirobot
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qasoffrittirobot" ). 
...
%-------------------------------------------------
%  User static rules about qasoffrittirobot
%------------------------------------------------- 
/*
------------------------------------------------------------------------
