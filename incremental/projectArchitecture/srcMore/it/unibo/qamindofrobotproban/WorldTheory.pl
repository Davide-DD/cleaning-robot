%==============================================
% WorldTheory.pl for actor qamindofrobotproban
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqamindofrobotproban).	%%old version (deprecated)
actorobj(qatuqamindofrobotproban).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qamindofrobotproban
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qamindofrobotproban" ). 
...
%-------------------------------------------------
%  User static rules about qamindofrobotproban
%------------------------------------------------- 
/*
------------------------------------------------------------------------
