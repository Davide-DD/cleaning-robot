%==============================================
% WorldTheory.pl for actor qacityinformationproban
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqacityinformationproban).	%%old version (deprecated)
actorobj(qatuqacityinformationproban).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qacityinformationproban
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qacityinformationproban" ). 
...
%-------------------------------------------------
%  User static rules about qacityinformationproban
%------------------------------------------------- 
/*
------------------------------------------------------------------------
