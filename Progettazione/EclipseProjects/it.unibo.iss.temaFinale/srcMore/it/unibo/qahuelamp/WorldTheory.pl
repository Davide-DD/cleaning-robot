%==============================================
% WorldTheory.pl for actor qahuelamp
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqahuelamp).	%%old version (deprecated)
actorobj(qatuqahuelamp).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qahuelamp
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qahuelamp" ). 
...
%-------------------------------------------------
%  User static rules about qahuelamp
%------------------------------------------------- 
ledmodel( name( huelamp),value( off)).
switchLedValue( on):-ledmodel( name( huelamp),value( off)),replaceRule( ledmodel( NAME,value( off)),ledmodel( NAME,value( on))), ! .
