...
public abstract class AbstractEvhtime extends EventHandlerComponent { 
protected IEventItem event;
	public AbstractEvhtime(String name, QActorContext myCtx, IOutputEnvView outEnvView, String[] eventIds ) throws Exception {
	...
	public void handleCurrentEvent() throws Exception {
		...
		Term msgPattern = Term.createTerm("timeEvent(VALUE)");
				boolean b = this.pengine.unify(msgt, msgPattern);
				if( b ) {
			  		sendMsg("timeMsg","qabusinesslogicproban", QActorContext.dispatch, msgt.toString() ); 
				}else{
