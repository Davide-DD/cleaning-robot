%==============================================
% WorldTheory.pl for actor qaselfmsg
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqaselfmsg).	%%old version (deprecated)
actorobj(qatuqaselfmsg).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qaselfmsg
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qaselfmsg" ). 
...
%-------------------------------------------------
%  User static rules about qaselfmsg
%------------------------------------------------- 
/*
------------------------------------------------------------------------
