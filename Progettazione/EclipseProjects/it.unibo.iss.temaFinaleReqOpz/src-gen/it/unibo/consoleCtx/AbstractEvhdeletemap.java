...
public abstract class AbstractEvhdeletemap extends EventHandlerComponent { 
protected IEventItem event;
	public AbstractEvhdeletemap(String name, QActorContext myCtx, IOutputEnvView outEnvView, String[] eventIds ) throws Exception {
	...
	public void handleCurrentEvent() throws Exception {
		...
		Term msgPattern = Term.createTerm("deleteMapCmd(INFO)");
				boolean b = this.pengine.unify(msgt, msgPattern);
				if( b ) {
			  		sendMsg("deleteMapMsg","qabusinesslogicproban", QActorContext.dispatch, msgt.toString() ); 
				}else{
