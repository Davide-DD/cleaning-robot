%==============================================
% WorldTheory.pl for actor qafrontend
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqafrontend).	%%old version (deprecated)
actorobj(qatuqafrontend).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qafrontend
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qafrontend" ). 
...
%-------------------------------------------------
%  User static rules about qafrontend
%------------------------------------------------- 
/*
------------------------------------------------------------------------
