%==============================================
% WorldTheory.pl for actor qahuelampemulatoractivator
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqahuelampemulatoractivator).	%%old version (deprecated)
actorobj(qatuqahuelampemulatoractivator).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qahuelampemulatoractivator
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qahuelampemulatoractivator" ). 
...
%-------------------------------------------------
%  User static rules about qahuelampemulatoractivator
%------------------------------------------------- 
/*
------------------------------------------------------------------------
