%==============================================
% WorldTheory.pl for actor qarobotproban
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqarobotproban).	%%old version (deprecated)
actorobj(qatuqarobotproban).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qarobotproban
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qarobotproban" ). 
...
%-------------------------------------------------
%  User static rules about qarobotproban
%------------------------------------------------- 
/*
------------------------------------------------------------------------
