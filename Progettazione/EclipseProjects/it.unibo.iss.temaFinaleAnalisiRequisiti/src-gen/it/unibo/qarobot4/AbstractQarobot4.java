...
public abstract class AbstractQarobot4 extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractQarobot4(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/qarobot4/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/qarobot4/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	        ...
	        switchToPlanAsNextState(pr, myselfName, "qarobot4_"+myselfName, 
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	//bbb
	     msgTransition( pr,myselfName,"qarobot4_"+myselfName,false,
	          new StateFun[]{stateTab.get("handleConsoleMsg"), stateTab.get("handleEnvironmentalEvent"), stateTab.get("handleCollisionEvent") }, 
	          new String[]{"true","M","consoleMsg", "true","E","environmentalEventViolation", "true","E","collisionEvent" },
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("handleConsoleMsg",-1);
	    	...
	    	repeatPlanNoTransition(pr,myselfName,"qarobot4_"+myselfName,false,true);
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("handleEnvironmentalEvent",-1);
	    	...
	    	//onEvent 
	    	setCurrentMsgFromStore(); 
	    	curT = Term.createTerm("environmentalEventViolation(\"bad_temp\")");
	    	if( currentEvent != null && currentEvent.getEventId().equals("environmentalEventViolation") && 
	    		pengine.unify(curT, Term.createTerm("environmentalEventViolation(REASON)")) && 
	    	...
	    	//onEvent 
	    	setCurrentMsgFromStore(); 
	    	curT = Term.createTerm("environmentalEventViolation(\"bad_time\")");
	    	if( currentEvent != null && currentEvent.getEventId().equals("environmentalEventViolation") && 
	    		pengine.unify(curT, Term.createTerm("environmentalEventViolation(REASON)")) && 
	    		pengine.unify(curT, Term.createTerm( currentEvent.getMsg() ) )){ 
	    			//println("WARNING: variable substitution not yet fully implemented " ); 
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("handleCollisionEvent",-1);
	    	...
	    	temporaryStr = "\"ROBOT: collisione rilevata dal sensore, per capire se è mobile aspetto un po', e se non ricevo più collisioni allora lo è\"";
	    	println( temporaryStr );  
