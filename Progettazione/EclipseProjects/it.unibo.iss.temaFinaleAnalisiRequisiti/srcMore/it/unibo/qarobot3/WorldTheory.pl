%==============================================
% WorldTheory.pl for actor qarobot3
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqarobot3).	%%old version (deprecated)
actorobj(qatuqarobot3).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qarobot3
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qarobot3" ). 
...
%-------------------------------------------------
%  User static rules about qarobot3
%------------------------------------------------- 
/*
------------------------------------------------------------------------
