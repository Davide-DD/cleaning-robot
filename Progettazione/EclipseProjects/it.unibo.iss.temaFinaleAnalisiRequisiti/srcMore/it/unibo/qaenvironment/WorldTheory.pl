%==============================================
% WorldTheory.pl for actor qaenvironment
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqaenvironment).	%%old version (deprecated)
actorobj(qatuqaenvironment).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qaenvironment
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qaenvironment" ). 
...
%-------------------------------------------------
%  User static rules about qaenvironment
%------------------------------------------------- 
/*
------------------------------------------------------------------------
