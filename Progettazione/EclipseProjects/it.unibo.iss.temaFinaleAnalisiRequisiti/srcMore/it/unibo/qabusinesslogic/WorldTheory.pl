%==============================================
% WorldTheory.pl for actor qabusinesslogic
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqabusinesslogic).	%%old version (deprecated)
actorobj(qatuqabusinesslogic).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qabusinesslogic
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qabusinesslogic" ). 
...
%-------------------------------------------------
%  User static rules about qabusinesslogic
%------------------------------------------------- 
...
evalTime( good):-curTimeValue( V),output( curTimeValue( V)),eval( ge,V,7),eval( lt,V,11), ! .
/*
------------------------------------------------------------------------
